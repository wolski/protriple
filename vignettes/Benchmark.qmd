...
allSpecnautXLSX <- grep(".xlsx$",dir("/Users/witoldwolski/__checkout/prolfquapp/inst/application/FragPipeDIA/", recursive = TRUE, full.names = TRUE), value = TRUE)
names <- gsub(".+FragPipeDIA//", "",allSpecnautXLSX) 
names <- gsub("/DE_.*","",names)
namesShort <- c("DIANN_Staggered", "DIANN", "FP_DIANN_Staggered", "FP_DIANN")
allSpecnautXLSX <- as.list(allSpecnautXLSX)
names(allSpecnautXLSX) <- namesShort


allSpecnautXLSXspec <- grep(".xlsx$",dir("/Users/witoldwolski/__checkout/prolfquapp/inst/application/specnaut/", recursive = TRUE, full.names = TRUE), value = TRUE)
names <- gsub(".+specnaut///", "",allSpecnautXLSXspec) 
names <- gsub("\\.xls/DE_.*","",names)
allSpecnautXLSXspec <- as.list(allSpecnautXLSXspec)

namesShort <- c("SPECNAUT_NoImpute_Staggered", "SPECNAUT_default_Staggered", "SPECNAUT_default")
...
```{r}
diff_exp_analysis <- lapply(allSpecnautXLSX, read_xlsx, sheet = 5)
protVariance <- lapply(allSpecnautXLSX, read_xlsx, sheet = 9)
